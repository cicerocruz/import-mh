...
class ImportMHTabModule extends AbstractModule implements ModuleTabInterface, ModuleCustomInterface
{
    ...
    protected function lithuanianTranslations() : array
    {
        ...
        return [
            'MyHeritage' => 'Pusbroliai / Pusseserės',
            ...
            '%2$s has %1$d first cousin recorded'
                . I18N::PLURAL . '%2$s has %1$d first MyHeritage recorded' => '%2$s turi %1$d įrašyta pirmos eilės pusbrolį/pusseserę'
    ...
    protected function danishTranslations() : array
    {
        // Note the special characters used in plural and context-sensitive translations.
        return [
            'MyHeritage' => 'Fætre og kusiner',
            'A tab showing MyHeritage of an individual.' => 'En fane der viser en persons fætre og kusiner.',
            'No family available' => 'Ingen familie tilgængelig',
            'Father\'s family (%s)' => 'Fars familie (%s)',
            'Mother\'s family (%s)' => 'Mors familie (%s)',
            '%2$s has %1$d first cousin recorded'
                . I18N::PLURAL . '%2$s has %1$d first MyHeritage recorded' => '%2$s har %1$d registreret fæter eller kusin'
    ...
    protected function finnishTranslations() : array
    {
        ...
        return [
            'MyHeritage' => 'Serkut',
            'A tab showing MyHeritage of an individual.' => 'Välilehti joka näyttää henkilön serkut.',
            'No family available' => 'Perhe puuttuu',
            'Father\'s family (%s)' => 'Isän perhe (%s)',
            'Mother\'s family (%s)' => 'Äidin perhe (%s)',
            '%2$s has %1$d first cousin recorded'
                . I18N::PLURAL . '%2$s has %1$d first MyHeritage recorded' => '%2$s:llä on %1$d serkku sivustolla'
    ...
    protected function hebrewTranslations() : array
    {
        // Note the special characters used in plural and context-sensitive translations.
        return [
            'MyHeritage' => 'בני דודים',
            'A tab showing MyHeritage of an individual.' => 'חוצץ המראה בני דוד של אדם.',
            'No family available' => 'משפחה חסרה',
            'Father\'s family (%s)' => 'משפחת האב (%s)',
            'Mother\'s family (%s)' => 'משפחת האם (%s)',
            '%2$s has %1$d first cousin recorded'
                . I18N::PLURAL . '%2$s has %1$d first MyHeritage recorded' => 'ל%2$s יש בן דוד אחד מדרגה ראשונה'
    ...
    protected function norwegianBokmålTranslations() : array
    {
        // Note the special characters used in plural and context-sensitive translations.
        return [
            'MyHeritage' => 'Søskenbarn',
            'A tab showing MyHeritage of an individual.' => 'Fane som viser en persons søskenbarn.',
            'No family available' => 'Ingen familie tilgjengelig',
            'Father\'s family (%s)' => 'Fars familie (%s)',
            'Mother\'s family (%s)' => 'Mors familie (%s)',
            '%2$s has %1$d first cousin recorded'
                . I18N::PLURAL . '%2$s has %1$d first MyHeritage recorded' => '%2$s har %1$d registrert søskenbarn'
    ...
    protected function czechTranslations() : array
    {
        ...
        return [
            ...
            'A tab showing MyHeritage of an individual.' => 'Panel zobrazující bratrance osoby.',
            'No family available' => 'Rodina chybí',
            'Father\'s family (%s)' => 'Otcova rodina (%s)',
            'Mother\'s family (%s)' => 'Matčina rodina (%s)',
            '%2$s has %1$d first cousin recorded'
                . I18N::PLURAL . '%2$s has %1$d first MyHeritage recorded' => '%2$s má %1$d bratrance'
